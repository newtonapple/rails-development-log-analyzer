...
== Tail your Rails development log
  ruby rails_log_stat.rb /path/to/your/development.log 'tail -f'

Note: 'tail -f' is optional and is use by default.  After running this command just run your App as you normally would w/ SQL log turned on.  
